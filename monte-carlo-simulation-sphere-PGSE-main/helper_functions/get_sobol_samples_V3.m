function params = get_sobol_samples_V3(projectpath,root_helper,Dex_sample,rmean_sample,rsd_sample,f_sample,kappa_dead_sample,f_alive_sample,Ncombos)
    ...
    if ~exist(sobol_arraypath,'file')
        ...
        fprintf(fileID, sprintf('%u %u\n%u %u\n%u %u\n%u %u\n%u %u\n%u %u\n%u', ...
            Dex_sample.lb, Dex_sample.ub, ...
            rmean_sample.lb, rmean_sample.ub, ...
            rsd_sample.lb, rsd_sample.ub, ...
            f_sample.lb, f_sample.ub, ...
            kappa_dead_sample.lb, kappa_dead_sample.ub, ...
            f_alive_sample.lb, f_alive_sample.ub, ...
            Ncombos));
        fclose(fileID);
        ...
        fullfile(projectpath)
        params = readmatrix('sobol_array.txt');
        % Params order is Dex, rmean, rsd, f, kappa_dead, f_alive
    end
